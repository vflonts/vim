...
" Colours {{{1
"" General {{{2
hi Normal       ctermfg=252 guifg=#d0d0d0 ctermbg=16  guibg=#1c1c1c cterm=none gui=none
...
" TODO
" hi MoreMsg
hi NonText      ctermfg=247 guifg=#9e9e9e ctermbg=16 guibg=#121212 cterm=bold gui=bold
